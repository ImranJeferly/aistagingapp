...
import { Calendar, Twitter, Facebook, Linkedin } from 'lucide-react';
...
export default function BlogPostPage() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      // params.id might be undefined initially
      if (!params?.id) return;
  ...
  if (loading) {
     return (
        <div className="min-h-screen bg-[#F0F9FF] pt-32 flex justify-center items-center">
            <h1 className="text-xl font-bold text-gray-500 animate-pulse">Loading Blog Post...</h1>
        </div>
     );
  }
