                ...
                <div ref={ctaRef} className="flex flex-wrap gap-4" style={{ opacity: 0 }}>
                    ...
                    {!isAuthenticated && (
                        <Button
                            variant="secondary"
                            size="lg"
                            className="!px-8 !py-4 !text-xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all flex items-center gap-3"
