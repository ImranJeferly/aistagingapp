...
export default function LoginPage() {
  ...
  return (
    <AuthLayout 
      title="Welcome back!" 
      subtitle="Sign in to continue staging your properties."
      variant="login"
    >
      {error && (
      ...
      <form onSubmit={handleEmailLogin} className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/forgot-password" className="text-sm font-bold text-[#8B5CF6] hover:text-[#7C3AED] hover:underline">
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <p className="mt-8 text-center text-gray-600 font-medium">
        ...
        <Link href="/register" className="font-bold text-[#8B5CF6] hover:text-[#7C3AED] hover:underline">
          Sign up for free
        </Link>
      </p>
    </AuthLayout>
